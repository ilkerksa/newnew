    ...
    chapters: [
        {
            ...
            description: 'Açıklama: Osmanlı İmparatorluğu’nun 400 yıl boyunca yönetim merkezi olan Topkapı Sarayı, muhteşem mimarisi ve zengin koleksiyonlarıyla büyüleyici bir atmosfere sahiptir. Sarayda, Osmanlı padişahlarının kullandığı eşyalar, kutsal emanetler ve Harem bölümü gibi önemli alanlar yer alır. Saray bahçelerinden İstanbul Boğazı’nın muhteşem manzarasını izlemek de mümkündür.',
            location: {
